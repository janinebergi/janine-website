...
export const alt = "Vorschaubild des Blogbeitrags auf janinebergmann.de";

export function generateStaticParams() {
  return getPostSlugs().map((slug) => ({ slug }));
}

// Die Karte wird beim Build erzeugt und kennt darum keine Sprach-Cookie –
// sie zeigt immer die deutsche Fassung des Beitrags.
export default async function OpengraphImage({
  ...
  const { site, pages } = getSiteContent("de");
  const meta = [
    post.country,
    formatDate(post.date, "de"),
